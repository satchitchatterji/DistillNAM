...
class NAMBaseDistill:
    ...
    def partial_fit(self, X, y, w=None) -> None:
        ...
        self.criterion = make_penalized_loss_func_distill(self.loss_func, 
            self.regression, self.output_reg, self.l2_reg)
...
class NAMClassifierDistill(NAMBaseDistill):
    def __init__(
        self,
        units_multiplier: int = 2,
        num_basis_functions: int = 64,
        ...
        super(NAMClassifierDistill, self).__init__(
            units_multiplier=units_multiplier,
            num_basis_functions=num_basis_functions,
            hidden_sizes=hidden_sizes,
            dropout=dropout,
...
class MultiTaskNAMClassifierDistill(NAMClassifierDistill):
    def __init__(
        self,
        units_multiplier: int = 2,
        num_basis_functions: int = 64,
        ...
        super(MultiTaskNAMClassifierDistill, self).__init__(
            units_multiplier=units_multiplier,
            num_basis_functions=num_basis_functions,
            hidden_sizes=hidden_sizes,
            dropout=dropout,
        ...
        if teacher_model is None:
            print("Warning: Using MultiTaskNAMClassifierDistill with no teacher. Use MultiTaskNAMClassifier instead!")
        self.teacher_model = teacher_model
        self.teacher_preprocess = teacher_preprocess
